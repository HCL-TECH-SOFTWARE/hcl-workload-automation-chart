...
| waconsole.console.db.type                           | The preferred remote database server type (e.g. DERBY, DB2, POSTGRES, ORACLE, MSSQL, IDS). Use Derby database only for demo or test purposes.                                                                                                                                    | yes           | DB2                              | DB2                                                |
...
| waserver.server.db.type                           | The preferred remote database server type (e.g. DERBY, DB2, POSTGRES, ORACLE, MSSQL, IDS)                                                                                                                                                                                               | yes           | DB2                              | DB2                                              |
